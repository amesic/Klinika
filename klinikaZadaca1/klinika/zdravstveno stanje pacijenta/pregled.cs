...
namespace zdravstveno_stanje_pacijenta
{
    public class pregled
    {
        ...
        private DateTime datumTerapije { get; set; }
        private List<ordinacija> listaordinacija { get; set; }
        //garancija doktora jos
        //kratkorocna ili dugorocna terapija
        //greska u propisivanju terapije

        //kontruktor koji opisuje jedan pregled
        public pregled()
        {
            dijagnoza = new List<string>();
            terapija = new List<string>();
            misljenjeDoktora = new List<string>();
            datumTerapije = new DateTime();
        ...
        //datum terapije
        public void dodajDatumTerapije(DateTime dt)
        {
            datumTerapije = dt;
        }
